            ...
            public void run() {
                try {
                    ...
                    for (int i=0;i<jsonArray.length();++i){
                        ...
                        Cloud_qiyefuwu_bean bean=new Cloud_qiyefuwu_bean(R.drawable.qiyefuwu_zhishichanquan_icon,jsonObjectcl.getString("qid"),"平均费用"+jsonObjectcl.getString("average_cost")+"元","园区使用频率"+jsonObjectcl.getString("park_use_rate")+"%","平均申请时间"+jsonObjectcl.getString("average_time")+"天");
