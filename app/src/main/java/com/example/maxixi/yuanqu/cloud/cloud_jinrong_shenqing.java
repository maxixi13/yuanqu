...
public class cloud_jinrong_shenqing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //服务
        LinearLayout fuwuxuanzelayout = (LinearLayout) findViewById(R.id.jinrong_jinrong_shengqing_fuwu_layout);
    ...
    private void Dialog() {
        //初始化字符串数组
        final String[] strArray = new String[]{"招商银行贷款", "平安银行贷款", "借钱"};
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);//实例化builder
        builder.setTitle("请选择服务");//设置标题
        //设置单选列表
