...
public class Fragmentjinrongdaikuan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        View view = inflater.inflate(R.layout.cctivity_cloud_jinrong_daikuanfg, container, false);

        initzhidaoList();
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.cloud_daikuan_recycler);
    ...
    private void initzhidaoList() {
        cloud_zhidao_lei madada = new cloud_zhidao_lei("借钱", "2018-06");
