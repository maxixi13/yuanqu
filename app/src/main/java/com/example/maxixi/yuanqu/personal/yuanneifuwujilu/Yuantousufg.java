...
public class Yuantousufg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.yuanqufuwujilu_tousu_recycler);
    ...
    private void getlist(){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request request=new Request.Builder().url(getString(R.string.tousuliebiao_url)).post(formBody).build();
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            for (int i=0;i<jsonArray.length();++i){
                                ...
                                Yuanqujilulei madada=new Yuanqujilulei(jsonObjectcl.getString("obj"),jsonObjectcl.getString("ctime"),jsonObjectcl.getString("cid"));
                            ...
                            yuanqujiluadapter.setOnItemClickListener(new Yuanqujiluadapter.OnItemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    Intent intent=new Intent(getContext(),Yuanqutousulist.class);
                                    intent.putExtra("cid",yuanqujiluleiList.get(position).getRid());
