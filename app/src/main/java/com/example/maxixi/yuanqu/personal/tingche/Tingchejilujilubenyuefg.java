...
public class Tingchejilujilubenyuefg extends Fragment{

    private List<tingchejilulei> jilulist=new ArrayList<>();

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState){
        View view =inflater.inflate(R.layout.dctivity_tingchejilu_monthlist,container,false);
    ...
    private void initjilulist(){
        tingchejilulei madada=new tingchejilulei("2001/01/01","20:00-25:00","10000");
        jilulist.add(madada);
        tingchejilulei madada1=new tingchejilulei("2001/01/01","20:00-25:00","10000");
        jilulist.add(madada1);
        tingchejilulei madada2=new tingchejilulei("2001/01/01","20:00-25:00","10000");
