...
//        });
        ...
        recyclerView = (RecyclerView)findViewById(R.id.cloud_qiyefuwu_caiwudaili_recycler);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    FormBody formBody=new FormBody.Builder().add("type","4").add("page",String.valueOf(page)).build();
                    ...
                    for (int i=0;i<jsonArray.length();++i){
                        ...
                        Cloud_qiyefuwu_bean bean=new Cloud_qiyefuwu_bean(R.drawable.qiyefuwu_caiwudaili_icon,jsonObjectcl.getString("qid"),"平均费用"+jsonObjectcl.getString("average_cost")+"元","园区使用频率"+jsonObjectcl.getString("park_use_rate")+"%","平均申请时间"+jsonObjectcl.getString("average_time")+"天",jsonObjectcl.getString("lid"));
                        ...
                        public void run() {
                            ...
                            cloud_qiyefuwu_adapter.setmOnItemClickListener(new Cloud_qiyefuwu_adapter.OnItemClickListener() {
                                ...
                                public void onItemClick(View view, int position) {
                                    Intent intent=new Intent(cloud_qiyefuwu_caiwudaili.this,cloud_qiyefuwu_gongshangzhuceSQ.class);
                                    intent.putExtra("lid",qiyefuwulist.get(position).getLid());
                                    intent.putExtra("title",qiyefuwulist.get(position).getQid());
                                    intent.putExtra("toolbartitle","财务代理");
                                    startActivity(intent);
                                }
                            });
                        }
