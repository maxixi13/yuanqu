...
public class Yfuwuqiyefg extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        View view = inflater.inflate(R.layout.dctivity_yunfuwushenqingfuwu_qiye, container, false);


        recyclerView = (RecyclerView) view.findViewById(R.id.yfuwu_qiye_recycler);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    FormBody formBody = new FormBody.Builder().add("type", "4").add("uid",uid).add("page", String.valueOf(page)).build();
